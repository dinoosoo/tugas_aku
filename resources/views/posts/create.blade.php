...
<head>
    ...
    <title>Tambah Data Hutang Teman</title>
                    ...
                    <div class="card-body">
                        <form action="{{ route('posts.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('nama_teman') is-invalid @enderror" name="nama_teman" value="{{ old('nama_teman') }}" placeholder="Masukkan Nama Teman">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control @error('tanggal_peminjaman') is-invalid @enderror" name="tanggal_peminjaman" value="{{ old('tanggal_peminjaman') }}">
